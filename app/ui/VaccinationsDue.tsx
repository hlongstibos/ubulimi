...
/** The bare list of due/overdue rows — reused both inside the dashboard's
 * collapsible preview and on the full /vaccinations management page. */
export function VaccinationsDueList({ rows }: { rows: DueRow[] }) {
  if (rows.length === 0) {
    return (
